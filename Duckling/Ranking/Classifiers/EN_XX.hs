...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6818476253060118, unseen = -5.8805329864007,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 356},
                   koData =
                     ClassData{prior = -0.704575876383568, unseen = -5.857933154483459,
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.1801261662305189, unseen = -5.093750200806762,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.0986122886681098),
                                    ("month (grain)", -2.7850112422383386),
                                    ("year (grain)", -2.6897010624340134),
                                    ("week (grain)", -1.0986122886681098),
                                    ("quarter", -3.4781584227982836), ("year", -2.6897010624340134),
                                    ("month", -2.7850112422383386),
                                    ("quarter (grain)", -3.4781584227982836)],
                               n = 76},
                   koData =
                     ClassData{prior = -1.80280930541464, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.2363887780642304, unseen = -5.153291594497779,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.662587827025453),
                                    ("integer (0..19)year (grain)", -3.2015843277581397),
                                    ("integer (numeric)day (grain)", -2.5825451193519164),
                                    ("integer (0..19)second (grain) ", -3.7612001156935624),
                                    ("integer (0..19)hour (grain)", -3.2015843277581397),
                                    ("second", -3.355735007585398),
                                    ("integer (numeric)second (grain) ", -4.048882188145344),
                                    ("integer (numeric)year (grain)", -3.068052935133617),
                                    ("day", -2.374905754573672), ("year", -2.5084371471981943),
                                    ("integer (numeric)week (grain)", -3.2015843277581397),
                                    ("integer (0..19)month (grain)", -3.7612001156935624),
                                    ("integer (20..90)minute (grain)", -4.454347296253507),
                                    ("hour", -2.8449093838194073), ("month", -3.068052935133617),
                                    ("integer (numeric)minute (grain)", -3.068052935133617),
                                    ("integer (0..19)minute (grain)", -3.068052935133617),
                                    ("integer (numeric)month (grain)", -3.5380565643793527),
                                    ("minute", -2.374905754573672),
                                    ("integer (numeric)hour (grain)", -3.7612001156935624),
                                    ("integer (0..19)day (grain)", -3.7612001156935624),
                                    ("integer (0..19)week (grain)", -3.355735007585398)],
                               n = 75},
                   koData =
                     ClassData{prior = -1.55814461804655, unseen = -4.143134726391533,
                               likelihoods =
                                 HashMap.fromList
