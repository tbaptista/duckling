...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6477455247806656, unseen = -5.953243334287785,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 383},
                   koData =
                     ClassData{prior = -0.7407085917588845, unseen = -5.860786223465865,
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.17384692980298236,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.1349799328389845),
                                    ...
                                    ("quarter", -3.5145260669691587), ("year", -2.4849066497880004),
                                    ("month", -2.8213788864092133),
                                    ("quarter (grain)", -3.5145260669691587)],
                               n = 79},
                   koData =
                     ClassData{prior = -1.8352445811677938, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.627081138568543),
                                    ("integer (0..19)year (grain)", -3.0325462466767075),
                                    ("integer (numeric)day (grain)", -2.5470384308950065),
                                    ("integer (0..19)second (grain) ", -3.7256934272366524),
                                    ("integer (0..19)hour (grain)", -3.16607763930123),
                                    ("second", -3.3202283191284883),
                                    ("integer (numeric)second (grain) ", -4.013375499688434),
                                    ("integer (numeric)year (grain)", -3.16607763930123),
                                    ("day", -2.339399066116762), ("year", -2.472930458741285),
                                    ("integer (numeric)week (grain)", -3.16607763930123),
                                    ("integer (0..19)month (grain)", -3.7256934272366524),
                                    ("integer (20..90)minute (grain)", -4.418840607796598),
                                    ("hour", -2.8094026953624978), ("month", -3.5025498759224427),
                                    ("integer (numeric)minute (grain)", -3.0325462466767075),
                                    ("integer (0..19)minute (grain)", -3.0325462466767075),
                                    ("integer (numeric)month (grain)", -4.418840607796598),
                                    ("minute", -2.339399066116762),
                                    ("integer (numeric)hour (grain)", -3.7256934272366524),
                                    ("integer (0..19)day (grain)", -3.7256934272366524),
                                    ("integer (0..19)week (grain)", -3.3202283191284883)],
                               n = 72},
                   koData =
                     ClassData{prior = -1.5260563034950494, unseen = -4.143134726391533,
                               likelihoods =
                                 HashMap.fromList
