...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6576404921030355, unseen = -5.846438775057725,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 344},
                   koData =
                     ClassData{prior = -0.7299611536826617,
                               unseen = -5.7745515455444085,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 320}}),
       ("<year> (bc|ad)",
        Classifier{okData =
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.1823215567939546, unseen = -5.081404364984463,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.0861897686695525),
                                    ("month (grain)", -2.772588722239781),
                                    ("year (grain)", -2.772588722239781),
                                    ("week (grain)", -1.0861897686695525),
                                    ("quarter", -3.4657359027997265), ("year", -2.772588722239781),
                                    ("month", -2.772588722239781),
                                    ("quarter (grain)", -3.4657359027997265)],
                               n = 75},
                   koData =
                     ClassData{prior = -1.791759469228055, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.6026896854443837),
                                    ("integer (0..19)year (grain)", -3.1416861861770706),
                                    ("integer (numeric)day (grain)", -2.5226469777708473),
                                    ("integer (0..19)second (grain) ", -3.7013019741124937),
                                    ("integer (0..19)hour (grain)", -3.1416861861770706),
                                    ("second", -3.295836866004329),
                                    ("integer (numeric)second (grain) ", -3.9889840465642745),
                                    ("integer (numeric)year (grain)", -3.295836866004329),
                                    ("day", -2.315007612992603), ("year", -2.6026896854443837),
                                    ("integer (numeric)week (grain)", -3.1416861861770706),
                                    ("integer (0..19)month (grain)", -3.7013019741124937),
                                    ("integer (20..90)minute (grain)", -4.394449154672439),
                                    ("hour", -2.7850112422383386), ("month", -3.4781584227982836),
                                    ("integer (numeric)minute (grain)", -3.0081547935525483),
                                    ("integer (0..19)minute (grain)", -3.0081547935525483),
                                    ("integer (numeric)month (grain)", -4.394449154672439),
                                    ("minute", -2.315007612992603),
                                    ("integer (numeric)hour (grain)", -3.7013019741124937),
                                    ("integer (0..19)day (grain)", -3.7013019741124937),
                                    ("integer (0..19)week (grain)", -3.295836866004329)],
                               n = 70},
                   koData =
                     ClassData{prior = -1.5040773967762742, unseen = -4.143134726391533,
                               likelihoods =
                                 HashMap.fromList
