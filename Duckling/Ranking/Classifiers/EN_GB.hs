...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6917377370567117, unseen = -5.877735781779639,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 355},
                   koData =
                     ClassData{prior = -0.694558613398353, unseen = -5.87493073085203,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 354}}),
       ("<year> (bc|ad)",
        Classifier{okData =
