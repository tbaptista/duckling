...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.670985608757093, unseen = -5.905361848054571,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 365},
                   koData =
                     ClassData{prior = -0.7158110401371572, unseen = -5.860786223465865,
       ...
       ("last|past|next <duration>",
        Classifier{okData =
                     ClassData{prior = -0.3894647667617233,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.5257286443082556), ("second", -2.3025850929940455),
                                    ("day", -2.3025850929940455), ("year", -2.8134107167600364),
                                    ("<integer> <unit-of-duration>", -0.8209805520698302),
                                    ("hour", -2.8134107167600364), ("month", -2.8134107167600364),
                                    ("minute", -2.3025850929940455)],
                               n = 21},
                   koData =
                     ClassData{prior = -1.1314021114911006, unseen = -3.367295829986474,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.2335922215070942), ("day", -2.2335922215070942),
                                    ("year", -2.2335922215070942),
                                    ("<integer> <unit-of-duration>", -0.9343092373768334),
                                    ("hour", -2.2335922215070942), ("month", -2.2335922215070942)],
                               n = 10}}),
       ...
       ("integer (0..19)",
        Classifier{okData =
                     ClassData{prior = -0.10724553035359756,
                               unseen = -4.007333185232471,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 53},
                   koData =
                     ClassData{prior = -2.2857779746776643,
                               unseen = -2.0794415416798357,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 6}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -1.9095425048844386),
                                    ...
                                    ("ordinals (first..twentieth,thirtieth,...)week (grain)intersect",
                                     -2.6026896854443837),
                                    ("weekmonth", -2.1972245773362196),
                                    ("ordinals (first..twentieth,thirtieth,...)quarter (grain)this|last|next <cycle>",
                                     -2.6026896854443837),
                                    ("ordinals (first..twentieth,thirtieth,...)day (grain)this|last|next <cycle>",
                                     -2.1972245773362196),
                                    ("dayweek", -2.6026896854443837),
                                    ("ordinals (first..twentieth,thirtieth,...)week (grain)October",
                                     -2.6026896854443837)],
                               n = 8},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinal (digits)quarter (grain)year (latent)",
                                    ...
                                    ("ordinals (first..twentieth,thirtieth,...)quarter (grain)year (latent)",
                                     -1.5040773967762742)],
                               n = 3},
                   koData =
                     ClassData{prior = -infinity, unseen = -1.3862943611198906,
       ...
       ("week (grain)",
        Classifier{okData =
                     ClassData{prior = -6.371581438610774e-2,
                               unseen = -4.356708826689592,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 76},
                   koData =
                     ClassData{prior = -2.7850112422383386,
                               unseen = -1.9459101490553135,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 5}}),
       ("<part-of-day> of <time>",
        Classifier{okData =
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.1779831551953564, unseen = -5.10594547390058,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.110882381259924),
                                    ("month (grain)", -2.797281334830153),
                                    ("year (grain)", -2.6149597780361984),
                                    ("week (grain)", -1.110882381259924),
                                    ("quarter", -3.4904285153900982), ("year", -2.6149597780361984),
                                    ("month", -2.797281334830153),
                                    ("quarter (grain)", -3.4904285153900982)],
                               n = 77},
                   koData =
                     ClassData{prior = -1.8137383759468302, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.3862943611198906),
                                    ("year (grain)", -2.5902671654458267),
                                    ("week (grain)", -1.3862943611198906),
                                    ("day", -2.0794415416798357), ("year", -2.5902671654458267),
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.24817962947553462, unseen = -5.10594547390058,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.6149597780361984),
                                    ("integer (0..19)year (grain)", -3.0204248861443626),
                                    ("integer (numeric)day (grain)", -2.5349170703626616),
                                    ("integer (0..19)second (grain) ", -3.713572066704308),
                                    ("integer (0..19)hour (grain)", -3.153956278768885),
                                    ("second", -3.3081069585961433),
                                    ("integer (numeric)second (grain) ", -4.001254139156089),
                                    ("integer (numeric)year (grain)", -3.3081069585961433),
                                    ("day", -2.327277705584417), ("year", -2.5349170703626616),
                                    ("integer (numeric)week (grain)", -3.153956278768885),
                                    ("integer (0..19)month (grain)", -3.713572066704308),
                                    ("integer (20..90)minute (grain)", -4.406719247264253),
                                    ("hour", -2.797281334830153), ("month", -3.4904285153900982),
                                    ("integer (numeric)minute (grain)", -3.0204248861443626),
                                    ("integer (0..19)minute (grain)", -3.0204248861443626),
                                    ("integer (numeric)month (grain)", -4.406719247264253),
                                    ("minute", -2.327277705584417),
                                    ("integer (numeric)hour (grain)", -3.713572066704308),
                                    ("integer (0..19)day (grain)", -3.713572066704308),
                                    ("integer (0..19)week (grain)", -3.3081069585961433)],
                               n = 71},
                   koData =
                     ClassData{prior = -1.5151272329628591, unseen = -4.143134726391533,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -3.028522096376982),
                                    ("integer (0..19)year (grain)", -3.4339872044851463),
                                    ...
                                    ("day", -3.028522096376982), ("year", -3.028522096376982),
                                    ("integer (numeric)week (grain)", -3.4339872044851463),
                                    ("integer (0..19)month (grain)", -3.4339872044851463),
                                    ("hour", -1.5621850275835547), ("month", -3.028522096376982),
                                    ("integer (numeric)month (grain)", -3.4339872044851463),
                                    ("integer (numeric)hour (grain)", -1.6422277352570913),
                                    ("integer (0..19)day (grain)", -3.4339872044851463),
                                    ("integer (0..19)week (grain)", -3.4339872044851463)],
                               n = 20}}),
